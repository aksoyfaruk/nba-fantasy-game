...
public class Center extends Player {
	...
	public Center(String playerName, String position, int PTS, int TRB, int AST, int BLK, int STL, double totalScore) {
		super(playerName, "C", PTS, TRB, AST, BLK, STL,0);
	...
	public double calculateScore() {
		...
		int lastPTS = Math.max(5, randomRange(PTS - n_PTS, PTS + n_PTS));
